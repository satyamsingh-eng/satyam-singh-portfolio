...
Parallel company research packet: [`company-research.json`](company-research.json)
...
The private research workflow used business contact details obtained through Apollo for personal recruiting outreach. The public dataset intentionally removes those email values and keeps only curated names, roles, LinkedIn routes, and verification limits. No message was sent and no external record was modified by this research run.
